<div class="container">
    <header class="flex justify-between items-center px-6 py-4">
        <!-- Logo -->
        <a href="#" class="logo">
            <img src="<?php echo e(asset('images/logo/logo-putih-baru.webp')); ?>" alt="Logo" width="150">
        </a>
...
<?php /**PATH C:\xampp\htdocs\metri_id\resources\views/components/layouts-service/navbar-services.blade.php ENDPATH**/ ?>