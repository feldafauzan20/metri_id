<footer class="w-full py-10 bg-center bg-no-repeat bg-cover">
    <div class="flex flex-row gap-20 px-10">
        <div class="flex flex-col pr-20">
            <img src="<?php echo e(asset('images/logo/logo-putih.png')); ?>" class="w-28">
...
<?php /**PATH E:\laragon\www\metri_id\resources\views/components/layouts-main/footer.blade.php ENDPATH**/ ?>