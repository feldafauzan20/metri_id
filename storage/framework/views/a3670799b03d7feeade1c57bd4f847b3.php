<section class="container my-20 text-white">
    <div class="flex items-start justify-between">
        ...
        <!-- Right Side: Form -->
        <form action="<?php echo e(route('contact.submit')); ?>" method="POST" class="space-y-6 w-full">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-3 mt-2">
                    <?php $__currentLoopData = [
                        ...
                        'tang ting' => '#d7bd38',
                        'metri post' => '#F7931E'
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service => $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="group flex items-center space-x-2 backdrop-blur-md bg-white/20 px-4 py-2 rounded-md cursor-pointer transition-all duration-300 ease-in-out hover:bg-white/30 active:scale-95">
                            <input type="checkbox" class="hidden peer" name="services[]" value="<?php echo e($service); ?>">
...
<?php /**PATH C:\xampp\htdocs\metri_id\resources\views/components/layouts/contact-form.blade.php ENDPATH**/ ?>