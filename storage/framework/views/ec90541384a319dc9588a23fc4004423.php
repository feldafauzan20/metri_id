...
<?php endif; ?>
        ...
        <section class="w-full h-full mx-4 lg:container">
            ...
            <div class="w-full mt-3 lg:mt-8 pr-8 lg:pr-0">
                <img src="<?php echo e(asset('images/bg-about.webp')); ?>" alt="" class="object-cover rounded-sm">
            </div>
        </section>
...
<?php endif; ?>
<?php /**PATH E:\laragon\www\metri_id\resources\views/about.blade.php ENDPATH**/ ?>