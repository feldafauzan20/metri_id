<x-layouts.layout>
    ...
    <x-slot:meta>
        <meta name="description"
            content="Metri Design crafts unique brand identities through meticulous design. Explore our portfolio & video showcases. Learn how we can elevate your brand's communication.">
        <meta name="keywords"
            content="Metri Design, brand identity, graphic design, design portfolio, video design, creative design, logo design, visual communication">
    ...
    <main>
            ...
            <div class="hero-content text-center">
                <div class="w-full flex flex-col items-center">
                    <a wire:navigate href="/" target="_self">
                        <img src="{{ asset('images/logo/logo-metri-design.webp') }}" alt="Metri Design Logo"
        ...
        <section class="lg:mx-4" itemprop="image" itemscope itemtype="http://schema.org/ImageGallery">
            <div class="grid lg:grid-cols-4 md:grid-cols-2 gap-4 lg:mx-auto mx-4 lg:py-20 py-10">
                <img src="{{ asset('storage/' . $photo_1) }}" alt="Metri Design Portfolio: Airplane"
                    class="col-span-1 row-span-2 w-full h-full object-cover rounded-lg" itemprop="contentUrl">
                <img src="{{ asset('storage/' . $photo_2) }}" alt="Metri Design Portfolio: Mountain"
                    class="col-span-1 row-span-1 w-full h-full object-cover rounded-lg" itemprop="contentUrl">
                <img src="{{ asset('storage/' . $photo_3) }}" alt="Metri Design Portfolio: Piano"
                    class="col-span-1 row-span-2 w-full h-full object-cover rounded-lg" itemprop="contentUrl">
                <img src="{{ asset('storage/' . $photo_4) }}" alt="Metri Design Portfolio: Sunset"
                    class="col-span-1 row-span-2 w-full h-full object-cover rounded-lg" itemprop="contentUrl">
                <img src="{{ asset('storage/' . $photo_5) }}" alt="Metri Design Portfolio: Portrait"
                    class="col-span-1 row-span-2 w-full h-full object-cover rounded-lg" itemprop="contentUrl">
            </div>
        </section>
        {{-- PORTO END --}}
                    ...
                    <div class="relative overflow-hidden rounded-lg h-96 group" itemprop="itemListElement" itemscope
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p class="text-2xl font-medium text-center text-white" itemprop="name">
                                    {{ $project->title }}</p>
