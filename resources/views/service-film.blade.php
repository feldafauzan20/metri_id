...
<x-layouts.layout>
    ...
    <main>
                    ...
                    <div class="w-full flex flex-col items-center">
                        <a wire:navigate href="/" target="_self" aria-label="Metri Films Logo">
                            <img src="{{ asset('images/logo/logo-metri-film.webp') }}"
                                alt="Metri Films Logo - Professional Film Production Services" class="w-[300px] lg:w-[600px]">
                        </a>
        ...
        {{-- Video start --}}
        <section class="w-full" id="video" aria-label="Film Showcase Video Section">
                ...
                @if (is_array($youtube_link))
                    @foreach ($youtube_link as $link)
                        ...
                        <div class="w-full h-[500px] pb-10">
                            <iframe class="w-full h-full object-contain" src="{{ $link }}" title="Metri Film Production Video" frameborder="0"
                ...
                @if (is_array($video))
                    @foreach ($video as $vid)
                        ...
                        <video class="object-cover w-full h-full" autoplay loop playsinline muted
                            title="Metri Film Storytelling Video">
            ...
            @else
                ...
                <p class="text-center text-gray-400">No film showcase video available.</p>
            @endif
        </section>
        {{-- Video end --}}
        ...
        <section class="my-32 px-4" id="proyek" aria-label="Recent Film Projects Section">
            ...
            <div class="grid grid-cols-1 gap-6 mx-4 md:mx-8 mt-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                @empty
                    <p class="text-white text-center col-span-3">No film projects available.</p>
                @endforelse
            </div>
        </section>
        {{-- PROJECT END --}}
