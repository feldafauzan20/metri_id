...
<x-layouts.layout>
    ...
    <x-slot:meta>
        <meta name="description" content="Explore Metri's gallery of diverse projects and campaigns. See our work in design, digital, entertainment, events, film, and post-production. View our portfolio today!">
        <meta name="keywords" content="Metri gallery, project portfolio, campaign portfolio, design projects, digital projects, entertainment projects, event projects, film projects, post-production projects, creative agency portfolio">
        <meta property="og:title" content="Metri Gallery | Project & Campaign Portfolio">
        <meta property="og:description" content="Explore Metri's gallery of diverse projects and campaigns. See our work in design, digital, entertainment, events, film, and post-production. View our portfolio today!">
    ...
    <main class="overflow-x-hidden">
        ...
        <section class="flex flex-col justify-center w-full h-full my-40 lg:container">
            <div class="mx-4 md:mx-8 h-full">
                <div class="flex flex-col gap-4">
                    ...
                    <p class="text-lg text-white md:text-xl" itemprop="description">A series of project and campaigns that we have worked on for various brands and clients.</p>
                </div>
            </div>
        </section>
        ...
        <section class="flex flex-col w-full lg:container">
            ...
            <div class="grid grid-cols-1 gap-6 mx-4 md:mx-8 mt-8 md:grid-cols-2 lg:grid-cols-3" itemprop="itemList" itemscope itemtype="http://schema.org/ItemList">
