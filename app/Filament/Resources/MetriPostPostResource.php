...
use App\Filament\Resources\MetriPostPostResource\Pages;
use App\Filament\Resources\MetriPostPostResource\RelationManagers;
...
{
    protected static ?string $model = MetriPostPost::class;
    ...
    public static function form(Forms\Form $form): Forms\Form
    {
        return $form->schema([
            ...
            ->directory(directory: 'metri_post_posts')
            ->label('video')
            ->nullable(),
    ...
    {
        return [
            'index' => Pages\ListMetriPostPosts::route('/'),
            'create' => Pages\CreateMetriPostPost::route('/create'),
            'edit' => Pages\EditMetriPostPost::route('/{record}/edit'),
        ];
    }
}
