...
use App\Filament\Resources\MetriFilmEquipmentResource\Pages;
use App\Filament\Resources\MetriFilmEquipmentResource\RelationManagers;
...
class MetriFilmEquipmentResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'tang-ting';
    ...
    {
        return [
            'index' => Pages\ListMetriFilmEquipment::route('/'),
            'create' => Pages\CreateMetriFilmEquipment::route('/create'),
            'edit' => Pages\EditMetriFilmEquipment::route('/{record}/edit'),
        ];
    }
}