...
{
    protected static ?string $model = MetriDigitalPost::class;
    ...
    {
        return [
            'index' => Pages\ListMetriDigitalPosts::route('/'),
            'create' => Pages\CreateMetriDigitalPost::route('/create'),
            'edit' => Pages\EditMetriDigitalPost::route('/{record}/edit'),
        ];
    }
}
