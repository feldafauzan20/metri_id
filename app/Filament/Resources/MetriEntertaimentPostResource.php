...
class MetriEntertaimentPostResource extends Resource
{
    ...
    public static function form(Forms\Form $form): Forms\Form
    {
        return $form->schema([
            ...
            ->directory(directory: 'metri_entertainment_posts')
            ->label('video')
            ->nullable(),
    ...
    {
        return [
            'index' => Pages\ListMetriEntertaimentPosts::route('/'),
            'create' => Pages\CreateMetriEntertaimentPost::route('/create'),
            'edit' => Pages\EditMetriEntertaimentPost::route('/{record}/edit'),
        ];
    }
}