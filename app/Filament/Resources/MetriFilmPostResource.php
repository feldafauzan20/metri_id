...
use App\Filament\Resources\MetriFilmPostResource\Pages;
use App\Filament\Resources\MetriFilmPostResource\RelationManagers;
...
class MetriFilmPostResource extends Resource
{
    protected static ?string $model = MetriFilmPost::class;
    ...
    public static function form(Forms\Form $form): Forms\Form
    {
        return $form->schema([
            ...
            ->directory(directory: 'metri_film_posts')
            ->label('video')
            ->nullable(),

            FileUpload::make('image')
            ->directory('metri_film_posts')
    ...
    {
        return [
            'index' => Pages\ListMetriFilmPosts::route('/'),
            'create' => Pages\CreateMetriFilmPost::route('/create'),
            'edit' => Pages\EditMetriFilmPost::route('/{record}/edit'),
        ];
    }
}
