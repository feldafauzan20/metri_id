...
use App\Filament\Resources\MetriFilmEquipmentPostResource\Pages;
use App\Filament\Resources\MetriFilmEquipmentPostResource\RelationManagers;
...
class MetriFilmEquipmentPostResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListMetriFilmEquipmentPosts::route('/'),
            'create' => Pages\CreateMetriFilmEquipmentPost::route('/create'),
            'edit' => Pages\EditMetriFilmEquipmentPost::route('/{record}/edit'),
        ];
    }
}
