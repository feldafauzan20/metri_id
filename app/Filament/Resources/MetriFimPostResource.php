...
use App\Filament\Resources\MetriFimPostResource\Pages;
use App\Filament\Resources\MetriFimPostResource\RelationManagers;
use App\Models\MetriFimPost;
use Filament\Forms;
...
class MetriFimPostResource extends Resource
{
    protected static ?string $model = MetriFimPost::class;
    ...
    {
        return [
            'index' => Pages\ListMetriFimPosts::route('/'),
            'create' => Pages\CreateMetriFimPost::route('/create'),
            'edit' => Pages\EditMetriFimPost::route('/{record}/edit'),
        ];
    }
}
